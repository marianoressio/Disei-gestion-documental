...
const AsignarForm = ({ employees, elementos, onSubmit }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result && result.error) {
        ...
        setSuccess("¡Elemento asignado correctamente!");
        setError("");
        setEmployeeId("");
        setElementoId("");
        setCantidad(1);
      ...
      setError("Error al asignar el elemento");
      setSuccess("");
    }
    setLoading(false);
  };
    ...
    <form className="space-y-4" onSubmit={handleSubmit}>
      <div>
        <label className="block text-sm font-medium mb-1">
          Empleado
          <span
            title="Seleccione el empleado al que se asignará el elemento"
      ...
      <div>
        <label className="block text-sm font-medium mb-1">
          Elemento
          <span
            title="Seleccione el elemento a asignar"
            className="ml-1 cursor-help text-gray-400"
          >
            &#9432;
          </span>
      ...
      <div>
        <label className="block text-sm font-medium mb-1">
          Cantidad
          <span
            title="Ingrese la cantidad a asignar (mayor a 0)"
            className="ml-1 cursor-help text-gray-400"
          >
            &#9432;
          </span>
      ...
      <div>
        <label className="block text-sm font-medium mb-1">
          Fecha de asignación
          <span
            title="Seleccione la fecha en que se realiza la asignación"
            className="ml-1 cursor-help text-gray-400"
          >
            &#9432;
          </span>
      ...
      <div>
        <label className="block text-sm font-medium mb-1">
          ...
          <span
            title="Puede ingresar una firma digital para validar la asignación"
            className="ml-1 cursor-help text-gray-400"
          >
            &#9432;
          </span>
